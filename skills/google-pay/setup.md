...
Read this when `~/Clawic/data/google-pay/` is missing or empty.
...
```bash
mkdir -p ~/google-pay
touch ~/Clawic/data/google-pay/{memory.md,implementations.md,validation-log.md,incidents.md}
chmod 700 ~/google-pay
chmod 600 ~/Clawic/data/google-pay/{memory.md,implementations.md,validation-log.md,incidents.md}
```
