...
- Keep the block narrow so it only affects discovery-heavy work.
- If the workspace already has a similar rule, refine the smallest relevant part instead of duplicating it.
